...
const updateCart = (food) => {
  ...
  axios
    ...
    .then((res) => {
      ...
      console.log(res.data.totalqty.totalQty)
      new Noty({
        type: "success",
        timeout: 1000,
...
// }
// resumebtn.addEventListener("submit", () => bookStatusResume());


// // Stop Booking Alert
// function bookStatusStop(){
//   const eventEmitter =req.app.get("eventEmitter");
//   let msgs="Food Bookings Closed"
//   eventEmitter.emit("bookingclosed",msgs)
// }

// stopbtn.addEventListener("submit", () =>  bookStatusStop());
